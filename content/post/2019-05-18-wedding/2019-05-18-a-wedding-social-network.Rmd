...
To get a clearer picture of our wedding guests' relation to one another, I convereted the adjacency matrix to the social network below. Each circle represents a person, the hearts represent me and my wife, and the grey lines indicate that the two people who are connectected had previously met. The structure results from the Fruchterman–Reingold algorithm, which, at a high-level, repels unconnected nodes but attracts connected nodes. What's cool is that this algorithm picks up on clusters that make intuitive sense (see legend colors).
